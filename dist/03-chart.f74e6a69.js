...
function ready(datapoints) {
  ...
  var BeijingDatapoints = datapoints.filter(function (d) {
  ...
  container.append('path').attr('class', 'temp').datum(nycDatapoints).attr('d', line).attr('fill', '#e41a1c').attr('opacity', 0.75);
  ...
  d3.select('#nyc').on('stepin', function () {
    container.selectAll('.temp').datum(nycDatapoints).attr('d', line).attr('fill', '#e41a1c').attr('opacity', 0.75);
    container.selectAll('.city-name').attr('text-anchor', 'middle') // .attr(‘class’, ‘city-name’)
    .text('NYC').attr('font-size', 30).attr('font-weight', 700).attr('alignment-baseline', 'middle');
  });
  d3.select('#beijing').on('stepin', function () {
    container.selectAll('.temp').datum(BeijingDatapoints) // .attr(‘d’, line)
    .attr('fill', '#377eb8'); // .attr(‘opacity’, 0.75)

    container.selectAll('.city-name').attr('text-anchor', 'middle').attr('class', 'city-name').text('Beijing').attr('font-size', 30).attr('font-weight', 700).attr('alignment-baseline', 'middle');
  });
  d3.select('#stockholm').on('stepin', function () {
    container.selectAll('.temp').datum(StockholmDatapoints).attr('d', line).attr('fill', '#4daf4a').attr('opacity', 0.75);
    container.selectAll('.city-name').attr('text-anchor', 'middle').attr('class', 'city-name').text('Stockholm').attr('font-size', 30).attr('font-weight', 700).attr('alignment-baseline', 'middle');
  });
  d3.select('#lima').on('stepin', function () {
    container.selectAll('.temp').datum(LimaDatapoints).attr('d', line).attr('fill', '#984ea3').attr('opacity', 0.75);
    container.selectAll('.city-name').attr('text-anchor', 'middle').attr('class', 'city-name').text('Lima').attr('font-size', 30).attr('font-weight', 700).attr('alignment-baseline', 'middle');
  });
  d3.select('#tuscon').on('stepin', function () {
    container.selectAll('.temp').datum(TusconDatapoints).attr('d', line).attr('fill', '#ff7f00').attr('opacity', 0.75);
    container.selectAll('.city-name').attr('text-anchor', 'middle').attr('class', 'city-name').text('Tucson').attr('font-size', 30).attr('font-weight', 700).attr('alignment-baseline', 'middle');
  });
